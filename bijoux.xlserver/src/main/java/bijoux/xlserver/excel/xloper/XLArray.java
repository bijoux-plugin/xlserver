...
public class XLArray extends XLoper
{
	...
	{
		set(row, column, value == null ? (XLoper) XLNil.NIL : new XLInt(value.intValue()));
	}
	...
	public void set(int row, int column, Double value)
	{
		set(row, column, value == null ? (XLoper) XLNil.NIL : new XLNum(value.doubleValue()));
	}
	...
	public void set(int row, int column, Boolean value)
	{
		set(row, column, value == null ? (XLoper) XLNil.NIL : new XLBool(value.booleanValue()));
	}
